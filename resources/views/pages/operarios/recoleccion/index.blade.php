    ...
    <div class="row justify-content-center">
        <div class="col-md-12 col-sm-12 ">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <br />
                    <form action="{{route('rec.contar')}}" method="post">
                        @csrf
                        ...
                        <div class="row justify-content-center" id="fin">
                            <div class="col-6">
                                <div class="d-grid gap-2">
                                    <button class="btn btn-success" type="submit">Recoger</button>
                                </div>
                            </div>
                        </div>
                            ...
                            <tbody>
                                @foreach($pedidos as $key => $ped)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            @if($ped->ESTADO_ID == 1)
                                                <span class="badge rounded-pill text-bg-danger">{{$ped->Estado->Nombre}}</span>
                                            @else 
                                                <span class="badge rounded-pill text-bg-success">{{$ped->Estado->Nombre}}</span>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
